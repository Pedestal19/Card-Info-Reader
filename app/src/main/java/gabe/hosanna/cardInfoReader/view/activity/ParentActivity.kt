...
abstract class ParentActivity: AppCompatActivity() {
    ...
    protected fun toastSuccess(msg: String) {
        MainApplication.instance?.applicationContext?.let {
            Toasty.success(it, "Got Card Details Successfully", Toast.LENGTH_SHORT, true).show() }
    }

    protected fun toastError(msg: String) {
        MainApplication.instance?.applicationContext?.let { Toasty.error(it, "Getting Card details failed, check card number", Toast.LENGTH_SHORT, true).show() }
    }
